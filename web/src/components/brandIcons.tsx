...
function Gmail({ s }: { s: number }) {
  return (
    <svg width={s} height={s} viewBox="0 0 24 24" aria-hidden="true">
      ...
      />
      <path
        d="M2 7.5v9.7c0 1 .8 1.8 1.8 1.8H5V9.9L2.6 6.2C2.2 6.5 2 7 2 7.5z"
        fill="#4285F4"
      />
      <path
        d="M22 7.5v9.7c0 1-.8 1.8-1.8 1.8H19V9.9l2.4-3.7c.4.3.6.8.6 1.3z"
        fill="#34A853"
      />
      <path
        d="M5 9.9 2.6 6.2c.3-.7 1-1.2 1.9-1.2.4 0 .9.2 1.2.4L12 10.6l6.3-5.2c.3-.2.8-.4 1.2-.4.9 0 1.6.5 1.9 1.2L19 9.9l-7 5.4z"
        fill="#EA4335"
      />
    </svg>
  );
...
function Notion({ s }: { s: number }) {
  return (
    <svg width={s} height={s} viewBox="0 0 24 24" aria-hidden="true">
      ...
      />
      <path
        d="M8 17V7.5l1.8-.3 5 7.6V7h1.7v9.6l-2 .4-4.8-7.3V17z"
        fill="var(--ink)"
      />
    </svg>
  );
...
function HubSpot({ s }: { s: number }) {
  return (
    <svg width={s} height={s} viewBox="0 0 24 24" aria-hidden="true">
      ...
      />
      <path
        d="M14.5 8.5V4.5M14.5 4.5h.01M6 5l5.2 5.2M7.5 19.5l3.6-3.6"
        stroke="#FF7A59"
        strokeWidth="2.2"
        strokeLinecap="round"
      />
...
function PagerDuty({ s }: { s: number }) {
  return (
    <svg width={s} height={s} viewBox="0 0 24 24" aria-hidden="true">
      ...
      <path
        d="M8.5 18.5v-3M8.5 13.5V6.2c1-.5 2.3-.7 3.6-.7 2.9 0 4.9 1.5 4.9 4s-2 4-5 4z"
        fill="none"
        stroke="#fff"
        strokeWidth="2"
        strokeLinecap="round"
...
function Telegram({ s }: { s: number }) {
  return (
    <svg width={s} height={s} viewBox="0 0 24 24" aria-hidden="true">
      ...
      <path
        d="m5.5 11.9 11.3-4.4c.5-.2 1 .1.8.9l-1.9 9.1c-.1.6-.5.8-1.1.5l-2.9-2.2-1.4 1.4c-.2.2-.3.3-.6.3l.2-3 5.5-5c.2-.2 0-.3-.3-.1l-6.8 4.3-2.9-.9c-.6-.2-.6-.7.1-.9z"
        fill="#fff"
      />
    </svg>
  );
...
const MARKS: Record<string, (p: { s: number }) => React.ReactElement> = {
  gmail: Gmail,
