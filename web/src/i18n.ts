...
export const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    idleTeardownRetrying:
      "Session runtime is still active; idle disconnect will retry.",
    ...
    wakeRuntimeFailed: "Session wake failed{detail}",
    ...
    changesError: "Unable to load changes.",
    noGitChanges: "No Git changes.",
    filesChangedSummary: "{count} files changed, +{additions} −{deletions}",
    ...
    diffError: "Unable to load this file diff.",
    binaryFile: "Binary file; no text diff is available.",
    noDiffHunks: "No textual changes to display.",
    added: "added",
    modified: "modified",
    deleted: "deleted",
    renamed: "renamed",
    untracked: "untracked",
    expandContext: "Expand {count} lines",
    expandAllContext: "Expand all context",
    collapseContext: "Collapse context",
    diffTruncated: "Diff truncated after {count} lines.",
  },
  zh: {
    general: "通用",
    ...
    workingNow: "正在工作",
    sleeping: "休眠中（将自动唤醒）",
    idleTeardownRetrying: "会话运行时仍在活动中；空闲断开将在稍后重试。",
    ...
    wakeRuntimeFailed: "会话唤醒失败{detail}",
    ...
    changes: "变更",
    refreshChanges: "刷新变更",
    changesLoading: "正在加载变更…",
    changesError: "无法加载变更。",
    noGitChanges: "没有 Git 变更。",
    filesChangedSummary:
      "{count} 个文件变更，新增 {additions} 行，删除 {deletions} 行",
    collapseDirectory: "折叠目录",
    expandDirectory: "展开目录",
    selectChangedFile: "选择一个变更文件。",
    diffLoading: "正在加载文件差异…",
    diffError: "无法加载该文件差异。",
    binaryFile: "二进制文件，无法显示文本差异。",
    noDiffHunks: "没有可显示的文本变更。",
    added: "新增",
    modified: "修改",
    deleted: "删除",
    renamed: "重命名",
    untracked: "未跟踪",
    expandContext: "展开 {count} 行",
    expandAllContext: "展开全部上下文",
    collapseContext: "收起上下文",
    diffTruncated: "差异已截断，仅显示前 {count} 行。",
  },
};
...
const backendErrorKeys: Record<string, string> = {
  ...
  idle_teardown_retrying: "idleTeardownRetrying",
  wake_runtime_failed: "wakeRuntimeFailed",
